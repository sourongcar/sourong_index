			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					...
					<li>
					    ...
					    <li>
						<a href="#" class="dropdown-toggle"> <i class="icon-tags"></i> <span class="menu-text">首页信息管理</span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
							<li>
								<a href="${path }/banner/list.action"target="contentframe"><i class="icon-double-angle-right"></i>轮播图片管理</a>
							</li>
						
							<li>
								<a href="${path }/consultant/list.action"target="contentframe"><i class="icon-double-angle-right"></i>融资规划师</a>
							</li>
								<li>
								<a href="${path }/serviceidea/list.action"target="contentframe"><i class="icon-double-angle-right"></i>服务理念管理</a>
							</li>
							<li>
								<a href="${path }/aboutsourong/list.action"target="contentframe"><i class="icon-double-angle-right"></i>区域管理管理</a>
							</li>
							<li>
								<a href="${path }/product/list.action"target="contentframe"><i class="icon-double-angle-right"></i>产品概况管理</a>
							</li>
							<li>
								<a href="${path }/companyinfom/list.action"target="contentframe"><i class="icon-double-angle-right"></i>公司基本信息管理</a>
							</li>
						</ul>
					</li>
				</ul>
