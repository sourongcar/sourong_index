...
public class ExtGenMain {
	...
	public static void main(String[] args) throws Throwable {
		...
		extGen.setDomainName("Serviceidea");///TODO domian名字,首字母大写
		extGen.setGroupid("com.sourongindex");///TODO 包名
		
		//生成java类
		extGen.setJavaPkgPrefix("/src/main/java/com/sourongindex/");///TODO java类
		...
		extGen.setDomainclass("com.sourongindex.serviceidea.domain.ServiceideaVO");//TODO domain全路径
